...
from gluefactory.models.extractors.jpldd.backbone_encoder import (
    AlikedEncoder,
    aliked_cfgs,
)
...
from gluefactory.models.extractors.jpldd.metrics_points import (
    compute_loc_error,
    compute_pr,
    compute_repeatability,
)
from gluefactory.models.extractors.jpldd.new_line_detection_jpldd import (
    detect_jpldd_lines,
)
...
class JointPointLineDetectorDescriptor(BaseModel):
    ...
    def _init(self, conf):
        ...
        if conf.training.do and conf.training.train_descriptors.do:
            ...
            self.aliked_lw = get_model("jpldd.aliked_light")(aliked_gt_cfg).eval()
